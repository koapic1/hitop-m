        ...
        <div class="contents">
            <form action="http://www.naver.com">
                <table class="board write">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="" id="" placeholder="제목을 입력해 주세요." /></td>
                        </tr>
                        <tr>
                            <th scope="row">이름<span class="require">*</span></th>
                            <td><input type="text" name="" id="" placeholder="이름을 입력해 주세요." /></td>
                        </tr>
                        <tr>
                ...
                <div class="btns center">
                    ...
                    <button class="btn cancle" type="reset">취소</button>
                </div>
            </form>
        </div>
    </div>
